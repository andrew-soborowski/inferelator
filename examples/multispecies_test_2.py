...
GOLD_STANDARD_FILE_NAME = 'Hsal_prior_matrix.tsv'
...
HSAL_TFS = 'hsal_tfs.tsv'

HVOL_EXPRESSION = 'hsal_simulated_expression.tsv'
HVOL_METADATA = 'hsal_simulated_metadata.tsv'
HVOL_PRIOR = 'Hsal_prior_matrix.tsv'
HVOL_TFS = 'hsal_tfs.tsv'
